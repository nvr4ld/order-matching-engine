...
class OrderBook{
    private:
        ...
        optional<Order> topBuyOrder;
        optional<Order> topSellOrder;
    public:
        mutex orderMutex;
        OrderBook(){
        ...
        optional<Order> getFrontBuyOrderVar(){
            return topBuyOrder;
        }

        optional<Order> getFrontSellOrderVar(){
            return topSellOrder;
        }

        void updateFrontBuyOrderVar(){
            if(!buyOrders.empty()){
                topBuyOrder = *(buyOrders.front());
            }
            else{
                topBuyOrder.reset();
            }
        ...
        void updateFrontSellOrderVar(){
            if(!sellOrders.empty()){
                topSellOrder = *(sellOrders.front());
            }
            else{
                topSellOrder.reset();
            }
        ...
        void loadFromFile(const string& filename) {
            ...
            updateFrontBuyOrderVar();
            updateFrontSellOrderVar();
        }
};
